...
A curated collection of free, public resources to help Imperial EEE/EIE students build practical technical skills and boost their employability in tech and engineering.
...
*   [Prof. Behzad Razavi's Electronics Lectures (YouTube)](https://www.youtube.com/watch?v=Fj2n3a0QvUU&list=PL7qKWvgGQlx_9yGksQZ5A8RjE6j1W_P_w) - UCLA's legendary professor teaching microelectronics. A must-watch for IC design and analog circuits.
...
*   [Brian Douglas: Control Systems Lectures (YouTube)](https://www.youtube.com/user/ControlLectures) - Arguably the best resource on the internet for intuitively understanding classical and modern control theory (Bode plots, root locus, PID, state-space).
*   [Control Tutorials for MATLAB and Simulink (CTMS)](https://ctms.engin.umich.edu/CTMS/index.php) - An amazing joint project by UMich and CMU that walks you through designing controllers for physical systems.
*   [Steve Brunton: Control Bootcamp (YouTube)](https://www.youtube.com/watch?v=Pi7l8mMjYVE&list=PLMrJAkhIeNNR20Mz-VpzgfQs5zrYi085m) - Excellent series from UW focusing on modern state-space control, LQR, and Kalman filters.
...
*   [Cornell ECE 4760: Designing with Microcontrollers](https://people.ece.cornell.edu/land/courses/ece4760/) - Prof. Bruce Land's course website is a legendary resource for bare-metal C programming, RTOS, and hardware interfacing (now focused on the Pi Pico/RP2040).
*   [Modern Embedded Systems Programming (YouTube)](https://www.youtube.com/playlist?list=PLPW8O6W-1chwyTzI3BHwBLbGQoPFxPAPM) - Miro Samek's incredible ground-up course on how embedded microprocessors actually work, down to the registers and memory maps.
...
*   [Fesz Electronics (YouTube)](https://www.youtube.com/c/FeszElectronics) - Deep dives into LTspice circuit simulation, switching power supplies, and analog design analysis.
*   [Learn Fusion 360 in 30 Days](https://www.youtube.com/playlist?list=PLrZ2zKOtC_-DR2ZkMaK3YthYLErPxCnT-) - A highly recommended crash course for generating custom mechanical enclosures and 3D CAD for your hardware projects.
*   [Analog Devices: LTspice Simulator](https://www.analog.com/en/design-center/design-tools-and-calculators/ltspice-simulator.html) - The industry-standard (and free) SPICE simulator. Check out their included educational examples.

### AI, Machine Learning & CUDA GPU Programming
*   [Dive into Deep Learning (Book)](https://d2l.ai/chapter_preface/index.html) & [Mathematics for Machine Learning (Book)](https://mml-book.github.io/)
*   [Deep Learning Systems Course](https://dlsyscourse.org/) & [MIT Course (Fall 2024)](https://hanlab.mit.edu/courses/2024-fall-65940)
*   [Sasha Rush's GPU Puzzles](https://Inkd.in/e2H5JdNn) & [Triton Puzzles](https://Inkd.in/ezeAv42E)
*   [Simon Boehm's CUDA Matmul Blog](https://Inkd.in/eYYWvy37) & [CUDA Kernels Repo](https://Inkd.in/ez3M4PQP)
...
3. Submit a Pull Request with a brief note on why the resource is valuable for an EEE/EIE student.
